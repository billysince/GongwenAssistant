...
namespace Local_Wps_Vsto
{
	public class WriterTips : Form
	{
		...
		public WriterTips(MyAddin ribbonDesign)
		{
		...
		private void All_DoWork_Handler_Web(object sender, DoWorkEventArgs args)
		{
			try
			{
				...
				if (IsFromWeb)
				{
					strWebResult = getSearchResultListFromWeb("nn", strSearchWord);
				}
				else
				{
		...
		private void WriterTips_Load(object sender, EventArgs e)
		{
			try
			{
				All_BgWorker_Web.WorkerReportsProgress = false;
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Local_Wps_Vsto.WriterTips));
			...
			this.rtbContent.Size = new System.Drawing.Size(582, 403);
			this.rtbContent.TabIndex = 1;
			this.rtbContent.Text = "";
			base.ClientSize = new System.Drawing.Size(582, 403);
			base.Controls.Add(this.rtbContent);
			base.Icon = (System.Drawing.Icon)resources.GetObject("$this.Icon");
			base.MaximizeBox = false;
			base.MinimizeBox = false;
			this.MinimumSize = new System.Drawing.Size(600, 450);
			base.Name = "WriterTips";
			this.Text = "写作提词器";
			base.FormClosed += new System.Windows.Forms.FormClosedEventHandler(WriterTips_FormClosed);
			base.Load += new System.EventHandler(WriterTips_Load);
			base.ResumeLayout(false);
		}

		private void WriterTips_FormClosed(object sender, FormClosedEventArgs e)
		{
			MyAddin.boolTbSuperWriter = false;
			MyAddin.thisAddIn.InvalidateControl("tbSuperWriter");
		}
	}
}
